...
func (x *PingResponse) GetData() bool {
	if x != nil {
		return x.Data
	}
	return false
...
const file_user_service_user_service_proto_rawDesc = "" +
	"\n" +
	"\x1fuser-service/user-service.proto\x12\fuser_service\"N\n" +
	...
	"\x04data\x18\x01 \x01(\bR\x04data2\x8a\x02\n" +
	"\vUserService\x12S\n" +
	"\x0eCreateUserGrpc\x12\x1f.user_service.CreateUserRequest\x1a .user_service.CreateUserResponse\x12Q\n" +
	"\x12GetUserByEmailGrpc\x12\x1c.user_service.GetUserRequest\x1a\x1d.user_service.GetUserResponse\x12S\n" +
	"\x0eDeleteUserGrpc\x12\x1f.user_service.DeleteUserRequest\x1a .user_service.DeleteUserResponse2\\\n" +
	"\x15UserServiceHealthGrpc\x12C\n" +
	"\bPingGrpc\x12\x19.user_service.PingRequest\x1a\x1a.user_service.PingResponse\"\x00B\x10Z\x0e.;user_serviceb\x06proto3"
...
var file_user_service_user_service_proto_goTypes = []any{
	...
	(*PingRequest)(nil),        // 6: user_service.PingRequest
	(*PingResponse)(nil),       // 7: user_service.PingResponse
}
var file_user_service_user_service_proto_depIdxs = []int32{
	0, // 0: user_service.UserService.CreateUserGrpc:input_type -> user_service.CreateUserRequest
	1, // 1: user_service.UserService.GetUserByEmailGrpc:input_type -> user_service.GetUserRequest
	2, // 2: user_service.UserService.DeleteUserGrpc:input_type -> user_service.DeleteUserRequest
	6, // 3: user_service.UserServiceHealthGrpc.PingGrpc:input_type -> user_service.PingRequest
	3, // 4: user_service.UserService.CreateUserGrpc:output_type -> user_service.CreateUserResponse
	4, // 5: user_service.UserService.GetUserByEmailGrpc:output_type -> user_service.GetUserResponse
	5, // 6: user_service.UserService.DeleteUserGrpc:output_type -> user_service.DeleteUserResponse
	7, // 7: user_service.UserServiceHealthGrpc.PingGrpc:output_type -> user_service.PingResponse
